{{ include('layouts/header.php', {title:'Modification du timbre'}) }}
...
<div class="login-page-content">
    ...
    <h2 class="titres-secondaires">Modification du timbre</h2>
    <p class="intro-texte">
...
{% endif %}
    ...
    <input type="hidden" name="user_id"  value="{{stamp.user_id}}">
        <button type="submit" value="Créer le timbre" class="bouton btn-primaire btn-moyen">Modifier</button>
